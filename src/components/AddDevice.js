...
export default function DialogBox(props) {
    ...
    const [serial, setSerialValue] = React.useState();
    ...
    async function addDevice() {
        await axios.post('http://localhost:9090/v1/api/device/add', {
            building :building,
            name : name,
            serial : serial,
    ...
    return (
        <Dialog open={open}
            ...
            <DialogActions style={{ marginTop: 30, borderTop: '1px solid #D3D3D3' }}>
                ...
                <Button onClick={addDevice} style={{ backgroundColor: '#305680', color: 'white', textTransform: 'capitalize' }}>Add</Button>
            </DialogActions>
        </Dialog>
    );
}