...
import DevicesDemo2 from './DevicesDemo2';
...
export default function PersistentDrawerLeft() {
    ...
    if (isAdmin) {
        DrawerContent = [
            { text: "Dashboard", Icon: <TimelineSharpIcon fontSize='large' /> },
            { text: "Devices", Icon: <SensorsSharpIcon fontSize='large' /> },
            { text: "Building", Icon: <ApartmentSharpIcon fontSize='large' /> },
            { text: "Settings", Icon: <ManageAccountsSharpIcon fontSize='large' /> },
        ];
    }
    else if (isCreator) {
        DrawerContent = [
            ...
            >
                ...
                <List sx={{}} >
                    {DrawerContent.map((content, index) => (
                        <ListItem button key={content.text} variant='side'>
                            <ListItemIcon >
                                {content.Icon}
                            </ListItemIcon>
